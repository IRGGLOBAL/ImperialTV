...
class AddFingerpring extends StatefulWidget {
  const AddFingerpring({super.key});

  @override
  State<AddFingerpring> createState() => _AddFingerpringState();
}

class _AddFingerpringState extends State<AddFingerpring> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AppText(
                            text: MyStrings.touchidforpaymentsauthorization.tr,
                        ...
                        AppText(
                            text: MyStrings.activatetouchidforuickransactions.tr,
                            style: semiBoldMediumLarge.copyWith(
